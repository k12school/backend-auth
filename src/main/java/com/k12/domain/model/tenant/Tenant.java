...
import static com.k12.domain.model.tenant.error.TenantError.NameError.NAME_SAME_AS_CURRENT;
import static com.k12.domain.model.tenant.error.TenantError.SubdomainError.SUBDOMAIN_SAME_AS_CURRENT;
import static com.k12.domain.model.tenant.error.TenantError.TenantStatusError.CANNOT_ACTIVATE_INACTIVE;
import static com.k12.domain.model.tenant.error.TenantError.TenantStatusError.TENANT_ALREADY_ACTIVE;
import static com.k12.domain.model.tenant.error.TenantError.TenantStatusError.TENANT_ALREADY_INACTIVE;
import static com.k12.domain.model.tenant.error.TenantError.TenantStatusError.TENANT_ALREADY_SUSPENDED;
import static java.time.Instant.now;

import com.k12.domain.model.common.Result;
import com.k12.domain.model.common.TenantId;
import com.k12.domain.model.tenant.commands.TenantCommands;
import com.k12.domain.model.tenant.commands.TenantCommands.ActivateTenant;
import com.k12.domain.model.tenant.commands.TenantCommands.DeactivateTenant;
import com.k12.domain.model.tenant.commands.TenantCommands.SuspendTenant;
import com.k12.domain.model.tenant.commands.TenantCommands.UpdateName;
import com.k12.domain.model.tenant.commands.TenantCommands.UpdateSubdomain;
import com.k12.domain.model.tenant.error.TenantError;
import com.k12.domain.model.tenant.events.TenantEvents;
import com.k12.domain.model.tenant.events.TenantEvents.TenantActivated;
import com.k12.domain.model.tenant.events.TenantEvents.TenantNameUpdated;
import com.k12.domain.model.tenant.events.TenantEvents.TenantSubdomainUpdated;
import com.k12.domain.model.tenant.events.TenantEvents.TenantSuspended;
import lombok.With;
