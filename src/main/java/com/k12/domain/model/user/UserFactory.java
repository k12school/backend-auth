...
import static com.k12.domain.model.user.error.UserError.EmailError.EMAIL_INVALID_FORMAT;
import static com.k12.domain.model.user.error.UserError.NameError.NAME_EMPTY;
import static com.k12.domain.model.user.error.UserError.PasswordError.PASSWORD_HASH_INVALID;
import static com.k12.domain.model.user.error.UserError.RoleError.ROLES_CANNOT_BE_EMPTY;

import com.k12.domain.model.common.Result;
import com.k12.domain.model.common.UserId;
import com.k12.domain.model.user.commands.UserCommands.CreateUser;
