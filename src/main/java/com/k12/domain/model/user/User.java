...
import static com.k12.domain.model.user.error.UserError.EmailError.EMAIL_SAME_AS_CURRENT;
import static com.k12.domain.model.user.error.UserError.NameError.NAME_SAME_AS_CURRENT;
import static com.k12.domain.model.user.error.UserError.PasswordError.PASSWORD_SAME_AS_CURRENT;
import static com.k12.domain.model.user.error.UserError.RoleError.CANNOT_REMOVE_LAST_ROLE;
import static com.k12.domain.model.user.error.UserError.RoleError.ROLE_ALREADY_ASSIGNED;
import static com.k12.domain.model.user.error.UserError.RoleError.ROLE_NOT_FOUND;
import static com.k12.domain.model.user.error.UserError.UserStatusError.USER_ALREADY_ACTIVE;
import static com.k12.domain.model.user.error.UserError.UserStatusError.USER_ALREADY_SUSPENDED;
import static java.time.Instant.now;

import com.k12.domain.model.common.Result;
import com.k12.domain.model.common.UserId;
import com.k12.domain.model.user.commands.UserCommands;
import com.k12.domain.model.user.commands.UserCommands.ActivateUser;
import com.k12.domain.model.user.commands.UserCommands.AddRole;
import com.k12.domain.model.user.commands.UserCommands.ChangePassword;
import com.k12.domain.model.user.commands.UserCommands.RemoveRole;
import com.k12.domain.model.user.commands.UserCommands.SuspendUser;
import com.k12.domain.model.user.commands.UserCommands.UpdateEmail;
import com.k12.domain.model.user.commands.UserCommands.UpdateName;
import com.k12.domain.model.user.error.UserError;
import com.k12.domain.model.user.events.UserEvents;
import com.k12.domain.model.user.events.UserEvents.UserActivated;
import com.k12.domain.model.user.events.UserEvents.UserEmailUpdated;
import com.k12.domain.model.user.events.UserEvents.UserNameUpdated;
import com.k12.domain.model.user.events.UserEvents.UserPasswordUpdated;
import com.k12.domain.model.user.events.UserEvents.UserRoleAdded;
import com.k12.domain.model.user.events.UserEvents.UserRoleRemoved;
import com.k12.domain.model.user.events.UserEvents.UserSuspended;
