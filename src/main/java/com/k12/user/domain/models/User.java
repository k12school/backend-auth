...
import static com.k12.user.domain.model.error.UserError.EmailError.EMAIL_SAME_AS_CURRENT;
import static com.k12.user.domain.model.error.UserError.NameError.NAME_SAME_AS_CURRENT;
import static com.k12.user.domain.model.error.UserError.PasswordError.PASSWORD_SAME_AS_CURRENT;
import static com.k12.user.domain.model.error.UserError.RoleError.CANNOT_REMOVE_LAST_ROLE;
import static com.k12.user.domain.model.error.UserError.RoleError.ROLE_ALREADY_ASSIGNED;
import static com.k12.user.domain.model.error.UserError.RoleError.ROLE_NOT_FOUND;
import static com.k12.user.domain.model.error.UserError.UserStatusError.USER_ALREADY_ACTIVE;
import static com.k12.user.domain.model.error.UserError.UserStatusError.USER_ALREADY_SUSPENDED;
import static java.time.Instant.now;

import com.k12.common.domain.model.Result;
import com.k12.common.domain.model.UserId;
import com.k12.user.domain.model.commands.UserCommands;
import com.k12.user.domain.model.commands.UserCommands.ActivateUser;
import com.k12.user.domain.model.commands.UserCommands.AddRole;
import com.k12.user.domain.model.commands.UserCommands.ChangePassword;
import com.k12.user.domain.model.commands.UserCommands.RemoveRole;
import com.k12.user.domain.model.commands.UserCommands.SuspendUser;
import com.k12.user.domain.model.commands.UserCommands.UpdateEmail;
import com.k12.user.domain.model.commands.UserCommands.UpdateName;
import com.k12.user.domain.model.error.UserError;
import com.k12.user.domain.model.events.UserEvents;
import com.k12.user.domain.model.events.UserEvents.UserActivated;
import com.k12.user.domain.model.events.UserEvents.UserEmailUpdated;
import com.k12.user.domain.model.events.UserEvents.UserNameUpdated;
import com.k12.user.domain.model.events.UserEvents.UserPasswordUpdated;
import com.k12.user.domain.model.events.UserEvents.UserRoleAdded;
import com.k12.user.domain.model.events.UserEvents.UserRoleRemoved;
import com.k12.user.domain.model.events.UserEvents.UserSuspended;
